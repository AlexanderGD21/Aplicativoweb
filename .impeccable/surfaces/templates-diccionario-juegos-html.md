...
FIRST VIEWPORT
En escritorio, la ruta y el selector ocupan una franja compacta y dejan ver las primeras modalidades. Dentro de una partida, el tablero es protagonista y los datos forman un rail breve. En móvil, filtros, tablero y acciones se apilan; ninguna modalidad depende de arrastrar o de hover y los objetivos táctiles miden al menos 44 px.
